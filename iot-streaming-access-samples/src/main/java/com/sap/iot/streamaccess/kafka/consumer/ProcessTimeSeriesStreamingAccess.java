 ...
 */
public class ProcessTimeSeriesStreamingAccess extends AbstractStreamingAccess {
    ...
    public ProcessTimeSeriesStreamingAccess(KafkaConsumer<String, byte[]> consumer) {
        super(consumer);
                ...
                try {
                    ...
                    for (ConsumerRecord<String, byte[]> record : records) {
                        ...
                        if (record.value() != null) {
                            ...
                            String message = messageParser.parseMessage(kafkaMsgIdentifier, deserializedMessage.toString(), DataModelType.THING_MODEL);
